...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("authorization_proof_type", sa.String(length=64), nullable=True),
        sa.Column("authorization_proof", sa.Text(), nullable=True),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("armoriq_token", sa.Text(), nullable=True),
        sa.Column("intent_plan", sa.JSON(), nullable=True),
        sa.Column("policy_decisions", sa.JSON(), nullable=False),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_index(op.f("ix_findings_risk_rating"), table_name="findings")
