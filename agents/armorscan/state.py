...
class ScanState(TypedDict):
    ...
    discovered_uploads: List[dict]
    discovered_js_endpoints: List[dict]
    authenticated_workflows: List[dict]
    repo_inventory: List[dict]
    dependency_inventory: List[dict]
    iac_inventory: List[dict]
